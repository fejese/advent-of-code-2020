...
ingredients_with_allergens = sorted(
    ingredient_by_allergen.values(),
    key=lambda ingredient: allergen_by_ingredient[ingredient],
)
print("Ingredients with allergens:", ingredients_with_allergens)
print(",".join(ingredients_with_allergens))
